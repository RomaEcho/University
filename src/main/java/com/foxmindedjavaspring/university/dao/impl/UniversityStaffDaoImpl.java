...
public class UniversityStaffDaoImpl implements GenericDao<UniversityStaff> {
    public static final String CREATE_UNIVERSITY_STAFF = "INSERT INTO university_staff VALUES(:staff_id, (SELECT id FROM persons WHERE first_name = :first_name AND last_name = : last_name AND address = :address), :title)";
